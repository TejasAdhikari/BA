...
import com.quickblox.sample.chat.java.db.QbUsersDbManager;
import com.quickblox.sample.chat.java.ui.fragments.AudioConversationFragment;
import com.quickblox.sample.chat.java.ui.fragments.BaseConversationFragment;
import com.quickblox.sample.chat.java.ui.fragments.ConversationFragmentCallback;
import com.quickblox.sample.chat.java.ui.fragments.IncomeCallFragment;
import com.quickblox.sample.chat.java.ui.fragments.IncomeCallFragmentCallbackListener;
import com.quickblox.sample.chat.java.ui.fragments.ScreenShareFragment;
import com.quickblox.sample.chat.java.ui.fragments.VideoConversationFragment;
import com.quickblox.sample.chat.java.services.CallService;
import com.quickblox.sample.chat.java.services.LoginService;
import com.quickblox.sample.chat.java.utils.Consts;
import com.quickblox.sample.chat.java.utils.ErrorUtils1;
import com.quickblox.sample.chat.java.utils.FragmentExecuotr;
import com.quickblox.sample.chat.java.utils.PermissionsChecker;
import com.quickblox.sample.chat.java.utils.QBEntityCallbackImpl;
import com.quickblox.sample.chat.java.utils.SettingsUtil;
import com.quickblox.sample.chat.java.utils.SharedPrefsHelper;
import com.quickblox.sample.chat.java.utils.ToastUtils;
import com.quickblox.sample.chat.java.utils.UsersUtils;
import com.quickblox.sample.chat.java.utils.WebRtcSessionManager;
 ...
 * QuickBlox team
 */
abstract public class CallActivity extends BaseActivity1 implements IncomeCallFragmentCallbackListener,
    ...
    private void checkPermission() {
        ...
        if (isVideoCall && checker.lacksPermissions(Consts.PERMISSIONS)) {
            if (cam) {
                ...
                ErrorUtils1.showSnackbar(rootView, R.string.error_permission_video, R.string.dlg_allow, new View.OnClickListener() {
                    @Override
            ...
            if (mic) {
                ...
                View rootView = getWindow().getDecorView().findViewById(android.R.id.content);
                ErrorUtils1.showSnackbar(rootView, R.string.error_permission_audio, R.string.dlg_allow, new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startPermissionSystemSettings();
                    }
