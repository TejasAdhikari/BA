...
public class UsersAdapter1 extends RecyclerView.Adapter<UsersAdapter1.ViewHolder> {
    ...
    public UsersAdapter1(Context context, List<QBUser> usersList) {
    ...
    @NonNull
    @Override
    public UsersAdapter1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_opponents_list, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull UsersAdapter1.ViewHolder holder, int position) {
