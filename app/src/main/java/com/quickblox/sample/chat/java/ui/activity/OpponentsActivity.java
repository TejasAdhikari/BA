...
import com.quickblox.sample.chat.java.ui.adapter.UsersAdapter1;
...
import com.quickblox.sample.chat.java.utils.CollectionsUtils;
import com.quickblox.sample.chat.java.utils.Consts;
import com.quickblox.sample.chat.java.utils.PermissionsChecker;
import com.quickblox.sample.chat.java.utils.PushNotificationSender;
 ...
 * QuickBlox team
 */
public class OpponentsActivity extends BaseActivity1 {
    ...
    private void initUsersList() {
        ...
        if (usersAdapter == null) {
            usersAdapter = new UsersAdapter1(this, currentOpponentsList);
            usersAdapter.setSelectedItemsCountsChangedListener(new UsersAdapter1.SelectedItemsCountChangedListener() {
                @Override
