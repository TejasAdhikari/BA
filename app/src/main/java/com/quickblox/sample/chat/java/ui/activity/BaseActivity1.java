...
import com.quickblox.sample.chat.java.util.QBResRequestExecutor;
...
public abstract class BaseActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestExecutor = App1.getInstance().getQbResRequestExecutor();
    ...
    protected void showErrorSnackbar(@StringRes int resId, Exception e,
        ...
        if (rootView != null) {
            ErrorUtils1.showSnackbar(rootView, resId, e, R.string.dlg_retry, clickListener);
        }
    }
